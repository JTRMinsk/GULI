...
//运行后在guli-parent下面出现target文件夹，到底是为什么？？？
...
// 2、全局配置 定义代码生成的文件夹位置
        ...
        String projectPath = System.getProperty("user.dir");//当前模组文件夹
        ...
        gc.setSwagger2(true);//开启Swagger2模式???用于创建接口说明和测试方法
...
// 4、包配置
        ...
        pc.setParent("org.salim.learn.guli.service");
...
//自动填充
        ...
        strategy.setSuperEntityClass("org.salim.learn.guli.service.base.model.BaseEntity");
